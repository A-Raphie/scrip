...
brokerage account. And people are buying them. But here's what nobody tells
you. When you buy one, all you receive is a number in your wallet. No
statement. No purchase history. No dividend notice. Nothing you could show
an accountant, or a friend, or yourself six months from now. And dividends
here don't arrive as cash at all: the issuer quietly raises an onchain
number, and your tokens become more shares overnight. If you never check,
you never know you got paid."
...
brokerage statement. Seventy-six lines, straight off the chain. Every buy,
every sell, dated and ordered, valued at the live oracle price on screen.
And this blue proof on every single line opens the exact transaction on
Basescan. Nothing here is stored in a database. There is no backend. The
chain is re-read, from scratch, every single time you open the page."
...
Unwind burns it and hands your USDC back. No manager. No fees. No keys."
...
become more shares. So Weft proved the whole loop on Base's testnet, where
the same B20 precompiles run live. One thousand dollars woven in. The
dividend lands: ten twenty. The split lands: fifteen thirty. Unwound. And
watch the raw balances in that table: they never moved. All of it flowed
through the multiplier, exactly how Coinbase designed it. And when the
first real dividend runs on mainnet, Weft renders it the same way,
automatically."
...
history: all of it reads straight from public endpoints. You don't have to
trust any of it. Check it."

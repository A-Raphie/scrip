// Coinbase Tokenized Stocks on Base, verified against
// docs.base.org/specifications/b20/tokenized-stocks-on-base on Sep 5, 2026.
// Chainlink total-return feeds follow the same source page.
...
export const TICKER_BY_TOKEN = new Map<string, Ticker>(
  TICKERS.map((t) => [t.token.toLowerCase(), t]),
);
